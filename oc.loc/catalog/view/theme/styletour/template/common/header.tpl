...
<head>
    ...
    <script rel="<?php echo $script['rel'];?>" href="<?php echo $script['href'];?>"></script>
    <?php endforeach; ?>

    <?php foreach($styles as $style): ?>
    <link rel="<?php echo $style['rel'];?>" href="<?php echo $style['href'];?>" type="text/css" media="<?php echo $style['media'];?>">
    <?php endforeach; ?>
    <!--[if lt IE 9]>
